Friend Module Tiles
    ...
    Friend ReadOnly TILE_TABLE As IReadOnlyDictionary(Of Integer, String) =
        New Dictionary(Of Integer, String) From
        {
            ...
            {TILE_WALL_SOUTH, "═"},
            {TILE_WALL_WEST, "║"},
            {TILE_CORNER_INSIDE_NORTHEAST, "╗"},
            {TILE_CORNER_INSIDE_SOUTHEAST, "╝"},
            {TILE_CORNER_INSIDE_SOUTHWEST, "╚"},
            {TILE_CORNER_INSIDE_NORTHWEST, "╔"},
            {TILE_CORNER_OUTSIDE_NORTHEAST, "╗"},
            {TILE_CORNER_OUTSIDE_SOUTHEAST, "╝"},
            {TILE_CORNER_OUTSIDE_SOUTHWEST, "╚"},
            {TILE_CORNER_OUTSIDE_NORTHWEST, "╔"},
            {TILE_DOOR_NORTH, "."},
            {TILE_DOOR_EAST, "."},
            {TILE_DOOR_SOUTH, "."},
            {TILE_DOOR_WEST, "."},
