Friend Module Tiles
    ...
    Friend ReadOnly TILE_TABLE As IReadOnlyDictionary(Of Integer, String) =
        New Dictionary(Of Integer, String) From
        {
            ...
            {TILE_WALL_WEST, "[blue]║[/]"},
            {TILE_FENCE_NORTH, "[silver]─[/]"},
            {TILE_FENCE_EAST, "[silver]│[/]"},
            {TILE_FENCE_SOUTH, "[silver]─[/]"},
            {TILE_FENCE_WEST, "[silver]│[/]"},
            ...
            {TILE_FENCE_CORNER_INSIDE_NORTHEAST, "[silver]┐[/]"},
            {TILE_FENCE_CORNER_INSIDE_SOUTHEAST, "[silver]┘[/]"},
            {TILE_FENCE_CORNER_INSIDE_SOUTHWEST, "[silver]└[/]"},
            {TILE_FENCE_CORNER_INSIDE_NORTHWEST, "[silver]┌[/]"},
