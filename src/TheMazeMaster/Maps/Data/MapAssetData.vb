...
Friend Class MapAssetData
    ...
    Private Shared ReadOnly terrainTable As IReadOnlyDictionary(Of Integer, TerrainIdentifier) =
        New Dictionary(Of Integer, TerrainIdentifier) From
        {
            ...
            {TILE_CORNER_INSIDE_NORTHEAST, TerrainIdentifier.WALL_CORNER_INSIDE_NORTHEAST},
            {TILE_CORNER_INSIDE_SOUTHEAST, TerrainIdentifier.WALL_CORNER_INSIDE_SOUTHEAST},
            {TILE_CORNER_INSIDE_SOUTHWEST, TerrainIdentifier.WALL_CORNER_INSIDE_SOUTHWEST},
            {TILE_CORNER_INSIDE_NORTHWEST, TerrainIdentifier.WALL_CORNER_INSIDE_NORTHWEST},
            {TILE_CORNER_OUTSIDE_NORTHEAST, TerrainIdentifier.WALL_CORNER_OUTSIDE_NORTHEAST},
            {TILE_CORNER_OUTSIDE_SOUTHEAST, TerrainIdentifier.WALL_CORNER_OUTSIDE_SOUTHEAST},
            {TILE_CORNER_OUTSIDE_SOUTHWEST, TerrainIdentifier.WALL_CORNER_OUTSIDE_SOUTHWEST},
            {TILE_CORNER_OUTSIDE_NORTHWEST, TerrainIdentifier.WALL_CORNER_OUTSIDE_NORTHWEST},
