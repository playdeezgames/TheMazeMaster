Friend Module Terrains
    Friend ReadOnly AllTerrains As IReadOnlyDictionary(Of TerrainIdentifier, Terrain) =
        New List(Of Terrain) From
        {
            ...
            New Terrain(TerrainIdentifier.DOOR_EAST, TILE_DOOR_EAST),
            New Terrain(TerrainIdentifier.DOOR_WEST, TILE_DOOR_WEST),
            New Terrain(TerrainIdentifier.DOOR_NORTH, TILE_DOOR_NORTH),
            New Terrain(TerrainIdentifier.DOOR_SOUTH, TILE_DOOR_SOUTH),
